...
Add text replacement/translation at column C, use the ◙ symbol to create a new line in the game, make sure you close XSLX before you try to convert it back to TRB, for edited **textresource_jpn.trb** file to load succesfully use included **code.bin** plugin and also add modded **textresource_config.trb** in (NLP+)**\SystemData\TextResource\**.
